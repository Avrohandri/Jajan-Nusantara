...
export function JadahTempeCardScreen() {
  ...
  return (
    <div 
      className="klepon-card-screen jadahtempe-theme"
      style={{ 
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-about-box">
          <p className="klepon-card-about-text">
            ...
            Disajikan bersama dalam satu gigitan, rasanya unik karena kombinasi gurih dan manis yang autentik.
          </p>
        </div>
        ...
        <div className="klepon-card-info-row">
          ...
          <div className="klepon-card-info-item">
            ...
            <p className="klepon-card-info-value">Ketan, Tempe</p>
          </div>
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Jadah tempe terkenal sebagai makanan khas daerah Kaliurang!
            </p>
          </div>
        </div>
      </div>
