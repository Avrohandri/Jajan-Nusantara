...
export function PieSusuCardScreen() {
  ...
  return (
    <div
      className="klepon-card-screen piesusu-theme"
      style={{
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-info-row">
          ...
          <div className="klepon-card-info-item">
            ...
            <p className="klepon-card-info-value">Tepung & Susu</p>
          </div>
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Pie susu menjadi oleh-oleh khas Bali yang sangat populer di seluruh Indonesia!
            </p>
          </div>
        </div>
      </div>
