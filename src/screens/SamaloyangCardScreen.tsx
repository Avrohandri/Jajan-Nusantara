...
export function SamaloyangCardScreen() {
  const { setScreen } = useGameStore();

  return (
    <div
      className="klepon-card-screen samaloyang-theme"
      style={{
    ...
    >
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-mascot-wrapper">
          ...
          <img src="/assets/foods_aceh/00_samaloyang.png" alt="Samaloyang Mascot" className="klepon-card-mascot" />
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Samaloyang dimasak dengan cetakan besi khas yang membuat bentuknya unik dan konsisten!
            </p>
          </div>
        </div>
      </div>
