...
import talamSaguBakarImg from '../assets/pedia/talam sagu bakar.png';

export function TalamSaguBakarCardScreen() {
  const { setScreen } = useGameStore();

  return (
    <div
      className="klepon-card-screen talamsagubakar-theme"
      style={{
    ...
    >
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-header">
          ...
          <h1 className="klepon-card-title">Talam Sagu Bakar</h1>
          <span className="klepon-card-leaf">🥧</span>
        </div>
        ...
        <div className="klepon-card-mascot-wrapper">
          ...
          <img src={talamSaguBakarImg} alt="Talam Sagu Bakar Mascot" className="klepon-card-mascot" />
        </div>

        {/* Tagline */}
        <div className="klepon-card-tagline">
          <span className="klepon-leaf-sm">✨</span>
          <p>Harum aroma panggang, lembut di dalam!</p>
          <span className="klepon-leaf-sm">✨</span>
        </div>
        ...
        <div className="klepon-card-about-box">
          <p className="klepon-card-about-text">
            Talam sagu bakar adalah kue berbahan <span className="klepon-highlight">sagu</span> yang dipanggang hingga matang sempurna. Memiliki tekstur lembut di bagian dalam dan sedikit renyah atau kering di luar.
          </p>
        </div>
        ...
        <div className="klepon-card-info-row">
          ...
          <div className="klepon-card-info-item">
            ...
            <p className="klepon-card-info-value">Sagu & Gula</p>
          </div>
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Proses pemanggangan membuat aroma talam sagu bakar menjadi sangat harum dan menggugah selera!
            </p>
          </div>
        </div>
      </div>
