...
import benduImg from '../assets/pedia/bendu.png';

export function BenduCardScreen() {
  const { setScreen } = useGameStore();

  return (
    <div
      className="klepon-card-screen bendu-theme"
      style={{
    ...
    >
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-header">
          ...
          <h1 className="klepon-card-title">Bendu</h1>
          <span className="klepon-card-leaf">🍡</span>
        </div>
        ...
        <div className="klepon-card-mascot-wrapper">
          ...
          <img src={benduImg} alt="Bendu Mascot" className="klepon-card-mascot" />
        </div>

        {/* Tagline */}
        <div className="klepon-card-tagline">
          <span className="klepon-leaf-sm">✨</span>
          <p>Gurih, sakral, dan tradisional!</p>
          <span className="klepon-leaf-sm">✨</span>
        </div>
        ...
        <div className="klepon-card-about-box">
          <p className="klepon-card-about-text">
            Bendu adalah jajanan berbahan ketan yang disajikan dengan <span className="klepon-highlight">kelapa parut</span>. Rasanya gurih dengan sedikit sentuhan manis yang khas.
          </p>
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Bendu sering hadir dalam acara adat sebagai bagian penting dari tradisi budaya Bali!
            </p>
          </div>
        </div>
      </div>
