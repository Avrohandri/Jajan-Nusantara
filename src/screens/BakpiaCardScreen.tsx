...
import bakpiaImg from '../assets/pedia/bakpia.png';

export function BakpiaCardScreen() {
  const { setScreen } = useGameStore();

  return (
    <div
      className="klepon-card-screen bakpia-theme"
      style={{
    ...
    >
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-header">
          ...
          <h1 className="klepon-card-title">Bakpia</h1>
          <span className="klepon-card-leaf">🍪</span>
        </div>
        ...
        <div className="klepon-card-mascot-wrapper">
          ...
          <img src={bakpiaImg} alt="Bakpia Mascot" className="klepon-card-mascot" />
        </div>

        {/* Tagline */}
        <div className="klepon-card-tagline">
          <span className="klepon-leaf-sm">✨</span>
          <p>Lembut di kulit, manis di hati!</p>
          <span className="klepon-leaf-sm">✨</span>
        </div>
        ...
        <div className="klepon-card-about-box">
          <p className="klepon-card-about-text">
            Bakpia adalah jajanan berbentuk bulat kecil dengan kulit lembut dan isian manis di dalamnya.
            Biasanya berisi <span className="klepon-highlight">kacang hijau, coklat, atau keju</span>,
            dan dipanggang hingga harum menggugah selera.
          </p>
        </div>
        ...
        <div className="klepon-card-info-row">
          ...
          <div className="klepon-card-info-item">
            ...
            <p className="klepon-card-info-value">Tepung, Kacang Hijau</p>
          </div>
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Bakpia sangat terkenal sebagai oleh-oleh khas Yogyakarta yang disukai banyak orang!
            </p>
          </div>
        </div>
      </div>
