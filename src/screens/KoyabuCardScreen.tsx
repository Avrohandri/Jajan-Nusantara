...
import koyabuImg from '../assets/pedia/koyabu.png';

export function KoyabuCardScreen() {
  const { setScreen } = useGameStore();

  return (
    <div
      className="klepon-card-screen koyabu-theme"
      style={{
    ...
    >
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-header">
          ...
          <h1 className="klepon-card-title">Koyabu</h1>
          <span className="klepon-card-leaf">🍡</span>
        </div>
        ...
        <div className="klepon-card-mascot-wrapper">
          ...
          <img src={koyabuImg} alt="Koyabu Mascot" className="klepon-card-mascot" />
        </div>

        {/* Tagline */}
        <div className="klepon-card-tagline">
          <span className="klepon-leaf-sm">✨</span>
          <p>Kenyal, manis, dan lumer di mulut!</p>
          <span className="klepon-leaf-sm">✨</span>
        </div>
        ...
        <div className="klepon-card-about-box">
          <p className="klepon-card-about-text">
            Koyabu adalah jajanan tradisional Maluku berbahan <span className="klepon-highlight">sagu</span> yang disajikan dengan kuah <span className="klepon-highlight">gula merah</span>. Teksturnya lembut dan sedikit kenyal dengan rasa manis yang dominan.
          </p>
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Koyabu biasanya disajikan selagi hangat sehingga cita rasa sagu dan gula merahnya lebih nikmat!
            </p>
          </div>
        </div>
      </div>
