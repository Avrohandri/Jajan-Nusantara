...
import yangkoImg from '../assets/pedia/yangko.png';

export function YangkoCardScreen() {
  const { setScreen } = useGameStore();

  return (
    <div 
      className="klepon-card-screen yangko-theme"
      style={{ 
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-about-box">
          <p className="klepon-card-about-text">
            ...
            kenyal seperti mochi. Biasanya <span className="klepon-highlight">berisi kacang manis</span> dan dilapisi tepung 
            agar tidak lengket saat dinikmati.
          </p>
        </div>
        ...
        <div className="klepon-card-info-row">
          ...
          <div className="klepon-card-info-item">
            ...
            <p className="klepon-card-info-value">Tepung Ketan, Kacang, Gula</p>
          </div>
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Yangko sering disebut sebagai mochinya Indonesia karena teksturnya yang mirip!
            </p>
          </div>
        </div>
      </div>
