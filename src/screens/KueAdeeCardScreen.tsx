...
export function KueAdeeCardScreen() {
  const { setScreen } = useGameStore();

  return (
    <div
      className="klepon-card-screen kueadee-theme"
      style={{
    ...
    >
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-mascot-wrapper">
          ...
          <img src="/assets/foods_aceh/06_kue adee.png" alt="Kue Adee Mascot" className="klepon-card-mascot" />
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Kue adee dikenal juga sebagai bingka khas Aceh (khususnya dari Meureudu, Pidie Jaya) yang sangat legendaris!
            </p>
          </div>
        </div>
      </div>
