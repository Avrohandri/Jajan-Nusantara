...
export function TimphanCardScreen() {
  ...
  return (
    <div
      className="klepon-card-screen timphan-theme"
      style={{
    ...
    >
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-header">
          ...
          <h1 className="klepon-card-title">Timphan</h1>
          <span className="klepon-card-leaf">🍃</span>
        </div>
        ...
        <div className="klepon-card-tagline">
          ...
          <p>Manis, legit, dan beraroma harum!</p>
          <span className="klepon-leaf-sm">✨</span>
        </div>
        ...
        <div className="klepon-card-about-box">
          <p className="klepon-card-about-text">
            Timphan adalah kue tradisional yang dibungkus <span className="klepon-highlight">daun pisang</span> dengan isi manis di dalamnya. Teksturnya sangat lembut dan legit.
          </p>
        </div>
        ...
        <div className="klepon-card-info-row">
          ...
          <div className="klepon-card-info-item">
            ...
            <p className="klepon-card-info-value">Tepung & Pisang</p>
          </div>
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Timphan adalah hidangan wajib yang sering disajikan saat hari besar atau acara spesial di Aceh!
            </p>
          </div>
        </div>
      </div>
