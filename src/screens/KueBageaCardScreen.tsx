...
export function KueBageaCardScreen() {
  ...
  return (
    <div
      className="klepon-card-screen kuebagea-theme"
      style={{
    ...
    >
      ...
      <div className="klepon-card-content">
        ...
        <div className="klepon-card-header">
          ...
          <h1 className="klepon-card-title">Kue Bagea</h1>
          <span className="klepon-card-leaf">🍪</span>
        </div>
        ...
        <div className="klepon-card-tagline">
          ...
          <p>Renyah di luar, padat di dalam!</p>
          <span className="klepon-leaf-sm">✨</span>
        </div>
        ...
        <div className="klepon-card-about-box">
          <p className="klepon-card-about-text">
            Kue bagea adalah kue kering berbahan <span className="klepon-highlight">sagu</span> dengan tekstur keras di luar namun padat di dalam. Memiliki rasa manis dengan aroma rempah-rempah yang khas.
          </p>
        </div>
        ...
        <div className="klepon-card-funfact">
          ...
          <div>
            ...
            <p className="klepon-card-funfact-text">
              Kue bagea adalah salah satu oleh-oleh paling ikonik dari Maluku yang sangat digemari wisatawan!
            </p>
          </div>
        </div>
      </div>
